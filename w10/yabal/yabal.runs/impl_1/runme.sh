...
HD_PWD='C:/Users/sogang/Desktop/yabal/yabal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_adder.tcl -notrace
