...
HD_PWD='C:/Users/sogang/Desktop/yabal/yabal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_adder.tcl
