...
HD_PWD='C:/Users/sogang/Desktop/ijustneedtimeohoahhhh/IJustNeedTimeOhOahhhh.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log code2421_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source code2421_counter.tcl -notrace
