...
HD_PWD='C:/Users/sogang/Desktop/ijustneedtimeohoahhhh/IJustNeedTimeOhOahhhh.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log code2421_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source code2421_counter.tcl
