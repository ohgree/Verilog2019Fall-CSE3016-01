...
HD_PWD='C:/Users/sogang/Desktop/hehehe/hehehe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aoi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aoi.tcl -notrace
