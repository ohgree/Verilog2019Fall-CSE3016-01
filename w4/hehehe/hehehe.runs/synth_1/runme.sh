...
HD_PWD='C:/Users/sogang/Desktop/hehehe/hehehe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aoi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aoi.tcl
