...
HD_PWD='C:/Users/sogang/Desktop/molbar/molbar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ParityGen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ParityGen.tcl -notrace
