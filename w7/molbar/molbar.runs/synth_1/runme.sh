...
HD_PWD='C:/Users/sogang/Desktop/molbar/molbar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ParityGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ParityGen.tcl
