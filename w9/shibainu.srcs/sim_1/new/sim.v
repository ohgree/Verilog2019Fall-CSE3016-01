...
module mux8sim;
    ...
    mux81 mux(in[7], in[6], in[5], in[4], in[3], in[2], in[1], in[0], s[2], s[1], s[0], q);
    
    initial in = 8'b00000000;
    initial s = 3'b000;
    always in = #100 in+1;
    always s = #25600 s+1;
...
module dc416sim;
    ...
    decoder416 dc(in[3], in[2], in[1], in[0], o0, o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11, o12, o13, o14, o15);
